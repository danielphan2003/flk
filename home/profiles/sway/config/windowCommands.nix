...
[
  ...
  (rule "floating enable" { app_id = "firefox"; title = "About Mozilla Firefox"; })
  (rule "floating enable, move position 700 965" { app_id = "firefox"; title = ".*Sharing Indicator"; })
  (rule "floating enable, move position 700 957, border pixel 1" { title = ".* sharing (a window|your screen)"; })
