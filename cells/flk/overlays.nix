{
  ...
  packageOverrides = nixlib.lib.mapAttrs (_: import)
...
in packageOverrides // {
  ...
  in {
    ...
    fog = let
      finalFog = l.mapAttrs (k: v: v.default) inputs.fog."${prev.system}".fog;
    in
      l.flk.mergeOn finalFog finalFog.all-packages;

    formats = l.flk.mergeOn prev.formats (import ./lib/pkgs-lib {inherit (final) lib pkgs;});
    ...
    minecraft-mods = final.minecraft-mods-builder fog.minecraft-mods {};
    ...
    papermc-pkgs = l.papermc.packagesBuilder {
      src = l.devos-ext.filterSrc "papermc-" fog.papermc;
    };
    ...
    python3Packages = l.flk.mergeOn
      prev.python3Packages
      (l.python3Packages.packagesBuilder {
        src = l.devos-ext.filterSrc "pythonPackages-" fog.all-packages;
      })
      ;
    ...
    vimPlugins = l.flk.mergeOn
      prev.vimPlugins
      (l.vimUtils.packagesBuilder {
        src = l.devos-ext.filterSrc "vimPlugins-" fog.all-packages;
      })
      ;

    vscode-extensions = l.flk.mergeOn
      prev.vscode-extensions
      (l.vscode-utils.packagesBuilder {
        src = fog.vscode-extensions;
      })
      {
